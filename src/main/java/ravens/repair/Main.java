...
public class Main {
	...
	public static void main(String args[]) {
		...
		Options opts = new Options();
                opts.addOption(Option.builder("p").longOpt("projectdir").hasArg().desc("specify the src directory name to fix").build());
	...
	//			        logger.info(insides);	//System.out.println("Size: " + candidatePairs.size());
	//				logger.debug("size "+ candidatePairs.size());
	...
	//					if(loc.getLine()==73)
	//				logger.info("candidatePatch " + candidatePatch);
	//					try {
	//						candidateCnt ++;
	//						System.out.println("=====================================");
